...
class AuthorFollowersPage extends StatefulWidget {
  final String authorId;
  final String authorName;

  const AuthorFollowersPage({
    super.key,
  ...
  @override
  State<AuthorFollowersPage> createState() => _AuthorFollowersPageState();
}

class _AuthorFollowersPageState extends State<AuthorFollowersPage> {
  ...
  Future<void> _loadFollowers({bool refresh = false}) async {
    ...
    try {
      final result = await _homeService.getAuthorFollowers(
        widget.authorId,
        page: _page,
        pageSize: _pageSize,
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppTheme.background,
        title: Text('${widget.authorName}的粉丝', style: AppTheme.titleStyle),
        centerTitle: true,
      ),
      body: _isLoading
          ? _buildLoadingState()
