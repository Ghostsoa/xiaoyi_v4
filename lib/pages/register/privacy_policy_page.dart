            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSection(
                    '7. 未成年人保护',
                    '本平台严格禁止未满18周岁的未成年人注册使用。鉴于本平台系基于人工智能大语言模型的角色扮演服务，AI生成内容具有不确定性和潜在风险，需要用户具备充分的辨别能力和法律认知能力。\n\n如果我们发现任何未满18周岁的用户注册使用本平台，我们将立即终止其账户并删除相关个人信息。我们呼吁家长和监护人加强对未成年人网络行为的监督和管理。',
                  ),
                  _buildSection(
                    '8. 第三方链接',
                  ...
                  _buildSection(
                    '9. 国际数据传输',
                    '我们可能在全球范围内处理和存储您的信息。使用我们的服务，即表示您同意将您的信息传输和处理到您可能居住地以外的国家和地区。',
                  ),
                  _buildSection(
                    '10. 政策变更',
